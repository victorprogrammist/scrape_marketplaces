...
&nbsp;
* **Универсальность API:** Загрузка данных не ограничена платформой 1С — вы можете использовать любые собственные скрипты и языки программирования для интеграции с сервисом.

## Использование из других скриптов (python)

В папке [python_scripts](python_scripts) пример использования на питоне.
