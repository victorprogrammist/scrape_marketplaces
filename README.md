...
| url_category | Ссылка на категорию поиска. Если не указано, то поиск с главной страницы |
| expected_count_items | Количество возвращаемых строк, ограничено 1000 |
| min_price | Отбор по минимальной цене. Можно не указывать. |
| max_price | Отбор по максимальной цене. Можно не указывать. |
