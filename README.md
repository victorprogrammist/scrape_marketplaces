...
Если без упаковки, но тогда ограничения по количеству запрашиваемых позиций,<br>
для страниц со списками - 50 позиций, для карточек товаров - 3 штуки.<br>
...
В среднем по 5 секунд на карточку, поэтому если запрашивает от 20 позиций,
значит и результат ждать долго.<br><br>
Запрос формируется в виде JSON текста с указанием соответствующих полей.<br>
