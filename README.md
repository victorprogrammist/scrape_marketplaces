...
<img width="1007" height="445" alt="2026-06-26_13-11" src="https://github.com/user-attachments/assets/98852ba6-190f-4d47-9a06-491828dc6aed" />
<br>
Здесь отображена статистика за ~8 дней, показан общий объем продаж, средняя сумма продаж за день, П1 - первая производная - как средняя продажа меняется каждый день, и Ошибка1 - что эта средняя продажа на самом деле болтается в этих пределах - какой-то день лучше, какой-то хуже. А для каких-то позиций сам сбор данных может оказываться не совсем качественный, но это отдельная тема.
<br><br>
