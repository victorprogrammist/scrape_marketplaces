...
Репозиторий содержит файл конфигурации [Ozon_1C_Demo_Configuration.dt](Ozon_1C_Demo_Configuration.dt) (или же оно же как расширение [Ozon_1C_Demo_Configuration.cfe](Ozon_1C_Demo_Configuration.cfe) для типовых конфигураций). Эта конфигурация демонстрирует интеграцию с этим сервисом сканирования маркетплейсов. Решение автоматически загружает данные о товарах и ценах на основе заданных пользователем фильтров и отборов.
