...
Из сервиса мониторинга цен это перерасло скорее в сбор статистик продаж. Сервис по прежнему работает, к нему можно выполнять запросы согласно описанным ниже правилам, но парсер постоянно забит моими запросами, и потому внешние запросы могут с большой вероятностью быть сбойными.<br><br>
Сейчас из готового и интересного есть рейтинги продаж по товарам выраженные в сумме продаж по позициям.<br>
Механизмов экспорта этих данных в удаленные базы пока нет, но если кому-то нужно такое, могу предоставлять слепок базы с готовыми цифрами.<br>
Если возникнет интерес, то вам сначала нужно мне сообщить интересующую категорию, чтобы я ее поставил на накопление.<br>
Весь Озон таким образом не закачать, и такое можно делать лишь с отдельными желаемыми категориями.<br><br>
